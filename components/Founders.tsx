...
const founders = [
  {
    ...
    email: "mailto:hello@redix.media",
  },
  {
    id: "f2",
    initials: "AR",
  ...
  },
  {
    ...
    bio: "Sara drives the content strategy and social media engine at REDIX.MEDIA — turning raw ideas into engaging narratives that grow brands online.",
    instagram: "https://instagram.com/redixmedia",
    linkedin: "https://linkedin.com/company/redixmedia",
    email: "mailto:hello@redix.media",
  },
          ...
          {founders.map((founder, i) => (
            ...
            >
              ...
              <div className="flex gap-3">
                {[
                  { icon: <InstagramIcon />, href: founder.instagram, label: "Instagram" },
                  { icon: <LinkedInIcon />,  href: founder.linkedin,  label: "LinkedIn" },
